...
const surfaceColors: Record<string, string> = {
  ...
  Cemento: "bg-orange-100 text-blue-700",
                  ...
                  <button
                    ...
                    className={`text-left p-4 rounded-xl border-2 transition-all duration-200 ${
                      selectedCourt === court.id
                        ? "border-[#CC5500] bg-orange-50 shadow-md"
                        : "border-gray-200 bg-white hover:border-[#CC5500] hover:shadow-sm"
                    }`}
                  >
                    <div className="flex items-start justify-between mb-2">
                      ...
                      {selectedCourt === court.id && (
                        <span className="text-[#CC5500] text-lg">✓</span>
                      )}
                    </div>
                        ...
                        <button
                          ...
                          className={`py-2 rounded-lg text-sm font-medium transition-colors ${
                            blocked
                              ...
                              : "bg-white border border-gray-200 text-gray-700 hover:border-[#CC5500] hover:text-[#CC5500]"
                          }`}
                        >
                          {slot}
                        </button>
              ...
              <div className="bg-white rounded-2xl shadow-md p-6 sticky top-24">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="bg-orange-50 rounded-xl p-4 text-sm space-y-1">
                    ...
                    <div className="border-t border-[#CC5500]/20 mt-2 pt-2 flex justify-between font-bold">
                      <span>Total:</span>
                  ...
                  <button
                    ...
                    className="w-full bg-[#CC5500] text-white py-3 rounded-xl font-bold hover:bg-[#993D00] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Confirmar Reserva
                  </button>
