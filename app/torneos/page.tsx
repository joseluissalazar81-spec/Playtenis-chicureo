...
const estadoColors: Record<string, string> = {
  ...
  "Inscripciones Abiertas": "bg-orange-100 text-blue-700",
...
const categoriaColors: Record<string, string> = {
  ...
  Juvenil: "bg-orange-100 text-sky-700",
};
                ...
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-sm font-medium transition-colors ${
                    filterEstado === e
                      ...
                      : "bg-white border border-gray-200 text-gray-600 hover:border-[#CC5500] hover:text-[#CC5500]"
                  }`}
                >
                  {e}
                </button>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      {t.ganador && (
                        <div className="text-right hidden sm:block">
                          ...
                          <div className="text-sm font-bold text-[#CC5500] truncate max-w-32">
                            {t.ganador}
                          </div>
                        </div>
                      )}
                  ...
                  <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-24">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-[#CC5500]">{selectedT.premio}</span>
                      </div>
                    ...
                    {(selectedT.estado === "Inscripciones Abiertas" ||
                      ...
                      <button className="w-full mt-4 bg-[#CC5500] text-white py-2.5 rounded-xl text-sm font-bold hover:bg-[#993D00] transition-colors">
                        Inscribirme
                      </button>
                    )}
                  </div>
                    ...
                    {ranking.map((player) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="text-center px-4 py-3 font-bold text-[#CC5500]">
                          ...
                          <td className="text-center px-4 py-3 hidden md:table-cell">
                            <div className="flex items-center gap-2 justify-center">
                              <div className="flex-1 bg-gray-100 rounded-full h-2 w-16">
                                <div
                                  className="bg-[#CC5500] h-2 rounded-full"
                                  style={{ width: `${winRate}%` }}
                                />
                              </div>
