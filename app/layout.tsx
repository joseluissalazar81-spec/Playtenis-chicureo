        ...
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div className="hidden sm:block">
              ...
              <span className="text-[#0288D1] text-xs font-medium tracking-wide">CHICUREO · COLINA</span>
            </div>
          </Link>
          <div className="flex items-center gap-1 sm:gap-2">
            <Link href="/" className="text-white/80 hover:text-[#0288D1] px-3 py-2 rounded-md text-sm font-medium transition-colors">Inicio</Link>
            <Link href="/canchas" className="text-white/80 hover:text-[#0288D1] px-3 py-2 rounded-md text-sm font-medium transition-colors">Canchas</Link>
            <Link href="/socios" className="text-white/80 hover:text-[#0288D1] px-3 py-2 rounded-md text-sm font-medium transition-colors">Socios</Link>
            <Link href="/torneos" className="text-white/80 hover:text-[#0288D1] px-3 py-2 rounded-md text-sm font-medium transition-colors">Torneos</Link>
            <a href="https://wa.me/56981588218?text=Hola!%20Quiero%20reservar%20una%20cancha%20en%20PlayTenis." target="_blank" className="ml-2 bg-[#29B6F6] text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-[#0277BD] transition-colors hidden sm:inline-block">
              Reservar
            </a>
          </div>
        </div>
    ...
    <footer className="desktop-only bg-[#2D2D2D] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="font-semibold text-[#0288D1] mb-4">Navegación</h3>
          ...
          <div>
            <h3 className="font-semibold text-[#0288D1] mb-4">Contacto</h3>
            <ul className="space-y-2 text-white/70 text-sm">
