...
function Navbar() {
  return (
    <header className="desktop-only fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm shadow-lg">
...
function Footer() {
  return (
    <footer className="desktop-only bg-white text-[#1d2433]">
