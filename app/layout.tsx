...
function Navbar() {
  return (
    <header className="desktop-only fixed top-0 left-0 right-0 z-50 bg-[#C5D629]/95 backdrop-blur-sm shadow-lg">
...
function Footer() {
  return (
    <footer className="desktop-only bg-[#C5D629] text-[#1d2433]">
  ...
  return (
    <html lang="es">
      <head>
        ...
        <meta name="theme-color" content="#C5D629" />
      </head>
      <body>
        <Navbar />
