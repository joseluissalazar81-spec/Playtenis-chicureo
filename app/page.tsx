  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #1a1a1a 0%, #2D2D2D 50%, #CC5500 100%)",
        }}
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white mb-6 leading-tight">
            Play<span className="text-[#CC5500]">Tenis</span>
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/canchas"
              className="bg-[#CC5500] text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#993D00] transition-colors shadow-lg hover:shadow-xl"
            >
              Reservar Cancha
            </Link>
            <Link
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-4xl font-black text-[#CC5500] mb-1">
                  {stat.value}
                </div>
      ...
      <section id="nosotros" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#CC5500] font-semibold text-sm uppercase tracking-wider">
                Sobre Nosotros
              </span>
            ...
            {plans.map((plan) => (
              <div
                ...
                className={`rounded-2xl p-8 relative ${
                  plan.highlight
                    ? "bg-[#CC5500] text-white shadow-2xl scale-105"
                    : "bg-gray-50 text-gray-800 shadow-md"
                }`}
              >
                {plan.highlight && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-white text-[#CC5500] text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wide">
                    Más Popular
                  </div>
                )}
                <h3
                ...
                <ul className="space-y-3 mb-8 text-left">
                  {plan.features.map((feat) => (
                    <li key={feat} className="flex items-start gap-2 text-sm">
                      <span
                        className={`mt-0.5 ${
                          plan.highlight ? "text-white" : "text-[#CC5500]"
                        }`}
                      >
                        ✓
                      </span>
                ...
                <Link
                  ...
                  className={`block text-center py-3 rounded-xl font-bold transition-colors ${
                    plan.highlight
                      ? "bg-white text-[#CC5500] hover:bg-orange-50"
                      : "bg-[#CC5500] text-white hover:bg-[#993D00]"
                  }`}
                >
                  Comenzar
                </Link>
      ...
      >
        <div className="max-w-3xl mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/canchas"
              className="bg-[#CC5500] text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#993D00] transition-colors"
            >
              Reservar Cancha
            </Link>
            <Link
